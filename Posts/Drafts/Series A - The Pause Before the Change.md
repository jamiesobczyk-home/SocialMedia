...
series: A
status: draft
tags: [series-a, systems-thinking, change-management, deliberate-pause, interviewing]
lens: systems thinking (with a quiet stoicism thread — respond vs react)
word_count: ~235
---
...
HOOK OPTION 2:
The most impressive thing I did early in my career was nothing. For about ten minutes.

ARC: situation (paper diagram) -> lesson (the pause) -> implication (interview question) -> closing question
-->
