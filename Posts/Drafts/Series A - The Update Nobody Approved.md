...
It's what it exposed. Most of us had change control. Staging rings, approval gates, maintenance windows. And the update that caused the biggest IT outage in history didn't pass through any of it, because content updates from the vendor didn't count as changes in anyone's process. The stated system said nothing changes without approval. The actual system had a side door.

Afterward, we made a list. Every agent on every endpoint that could receive an update without a ticket. Antivirus content. Management tools. Browser extensions pushed by vendors. Firmware that phones home. The list was longer than I expected, and I've been doing this a long time.
...
How many things on your network can update themselves without anyone approving it? Do you know the number?
